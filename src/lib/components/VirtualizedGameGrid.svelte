<script lang="ts">
    import { formatSize, games, searchGames, searchQuery, selectedIndex } from '$lib/stores/games';
    ...
    >
        <div class="scroll-area" style="height: {totalHeight}px;">
            <div class="visible-items" style="transform: translateY({offsetY}px);">
                <div class="grid-wrapper" style="grid-template-columns: repeat({columnsPerRow}, {CARD_WIDTH}px); gap: {GAP}px; padding: 0 {PADDING}px;">
                    {#each visibleGames as game, index (game.id)}
                        ...
                        >
                            <div class="game-image">
                                <CachedImage 
                                    src={game.image_url} 
                                    alt={game.clean_name || game.title} 
                                />
                            </div>
                            <div class="game-info">
